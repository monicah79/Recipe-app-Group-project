...
firth_food = Food.create(name: "Food 4", price: "100", measurement_unit: "ltr")
...
fourth_recipe = Recipe.create(name: "Recipe 4", preparation_time: "2", cooking_time: "1", description: "Description for Recipe 4", public: false, user: second_user)
